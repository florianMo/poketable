        ...
        >
          ...
          <ButtonGroup disableRipple style={{ width: "100%", display: "flex" }}>
            {avatars.map((a, i) => (
              ...
              >
                <img
                  src={`/poketable/img/avatars_portrait/${a.imgPortrait}`}
                  alt=""
                  style={{
                    maxWidth: "100%",
                    filter: `grayscale(${i === config.avatar ? 0 : 0.5})`,
                  }}
                />
                {/* <h5 style={{
          ...
          <ButtonGroup
            disableRipple
            style={{ width: "100%", display: "flex", padding: "0 25%" }}
          >
            {[
              ...
              >
                <div
                  style={{
                    ...
                    opacity: t.v === config.multi ? 1 : 0.7,
                  }}
                >
                  <AddIcon
                    style={{
              ...
              {!config.multi && (
                ...
                >
                  <FormControl component="fieldset" fullWidth margin="normal">
                    ...
                    <Slider
                      value={
                        typeof config.addiMax === "number" ? config.addiMax : 0
                      }
                      onChange={(e, v, n) =>
                        handleSliderChange(e, v, "addiMax")
                      }
              ...
              {config.multi && (
                ...
                >
                  <FormControl component="fieldset" fullWidth margin="normal">
                    ...
                    <Slider
                      value={
                        typeof config.multiMax === "number"
                          ? config.multiMax
                          : 0
                      }
                      onChange={(e, v, n) =>
                        handleSliderChange(e, v, "multiMax")
                      }
                      aria-labelledby="input-slider"
                      min={1}
                      max={10}
